...
/*   Updated: 2018/10/04 14:13:02 by nobrien          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "./includes/ft_malloc.h"

// need to check realloc(ptr + 5, ...) free(ptr + 5), preallocate, 
...
// check for when realloc is smaller than malloc
	...
	void *final = malloc(1024*1024*1024);
	for (int i = 0; i < 4000; i++)
		((char*)final)[i] = 'a';
	ft_printf("Pre memory\n");
	show_alloc_mem();
	ft_printf("\n");
	...
	void *ptr2 = malloc(10100);
	ptr2 = realloc(ptr2,4000);
